...
namespace DoctrineORMModule\Proxy\__CG__\Tax\Model;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class TaxTable extends \Tax\Model\TaxTable implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Tax\\Model\\TaxTable' . "\0" . 'id', '' . "\0" . 'Tax\\Model\\TaxTable' . "\0" . 'description', '' . "\0" . 'Tax\\Model\\TaxTable' . "\0" . 'effectiveDate', '' . "\0" . 'Tax\\Model\\TaxTable' . "\0" . 'operator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxTable $proxy) {
